...
#calculate the distance of everypoint of the map to the nearest routes on the map and plot the min of the sum of all distances
...
find_df() #this plot all the points of the routes
...
pt = paths.T
densObjnew = kde(pt)
print(type(densObjnew.evaluate(pt)))
exit()
...
#plt.plot(paths[:,0], paths[:,1], 'o', alpha=0.8, linestyle="", markersize=0.8)
plt.show()
